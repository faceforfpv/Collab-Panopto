...
# Sample Use: python upload.py --server bbdemo.hosted.panopto.com --folder-id 86cbf247-d48f-4ca5-a5c0-abda01773552 --upload-file 1minwsound.a.mp4 --client-id 1234c723-f39a-453b-b349-ab1234abcda7af5 --client-secret vn0n0furbizKPSxU= --username developers@blackboard.com --password ScMa^2ErDa5
import argparse
import datetime
